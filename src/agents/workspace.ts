...
export const DEFAULT_NETWORK_FILENAME = "NETWORK.md";
...
export type WorkspaceBootstrapFileName =
  ...
  | typeof DEFAULT_NETWORK_FILENAME
...
export async function loadWorkspaceBootstrapFiles(dir: string): Promise<WorkspaceBootstrapFile[]> {
  ...
  const entries: Array<{
    ...
    {
      name: DEFAULT_NETWORK_FILENAME,
      filePath: path.join(resolvedDir, DEFAULT_NETWORK_FILENAME),
    },
  ];
